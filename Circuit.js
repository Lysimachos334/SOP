function Circuit(n,EPI,Chart){
	...
	for(var a=0;a<Number_of_EPI;a++){
		var temp=new And_Gate(EPI[a],800,100*(a)+150);
			Anding.push(temp);
		console.log(a+1);
	}
	class OR_Gate{
		constructor(){
			this.posX=1000;
			this.posY=150+Math.floor(Number_of_EPI/2)*100;
			this.output=0;
		...
		Print(){
			...
			context.fillStyle="rgba("+255*this.output+",0,0,1)";
	...
	function Variables_input(){
		context.font="25px Lucida Grande";
		for(i=0;i<N;i++){
